...
public class ExtentManager extends BaseTest
{
	...
	private static String reportFileName = System.getProperty("Environment")+" "+System.getProperty("BuildVersion")+" UI Report-"+todaysDate()+".html";
    ...
    public static ExtentReports getInstance()
    {
        if (extent == null)
            ...
            {
				System.out.println("Unable to create extent reports instance: "+e.getMessage());
			}
